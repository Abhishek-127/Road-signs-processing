...
# Algorithm based on https://www.pyimagesearch.com/2018/09/17/opencv-ocr-and-text-recognition-with-tesseract/
# python A3/text_recognition.py --east A3/frozen_east_text_detection.pb --image A3/image.jpg
